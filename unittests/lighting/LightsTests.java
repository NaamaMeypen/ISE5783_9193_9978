...
//      scene2.geometries.add(triangle1, triangle2);
//      scene2.lights.add(new SpotLight(sphereLightColor, sphereLightPosition, trianglesLightDirection,0.5).setKl(0.001).setKq(0.0001));
//
...
//      scene1.geometries.add(sphere);
//      scene1.lights.add(new SpotLight(trianglesLightColor, sphereLightPosition, new Vector(1, 1, -0.5),0.1).setKl(0.001).setKq(0.0001));
//
